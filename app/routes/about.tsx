...
export default function About() {
  ...
  const sectionBg =
    theme === "dark"
      ? "bg-gradient-to-b from-transparent to-slate-800/20"
      : "bg-gradient-to-b from-transparent to-slate-100/30";
    ...
    <div className={`min-h-screen transition-all duration-300 ${themeClasses}`}>
      ...
      <section className="min-h-screen flex items-center justify-center text-center relative overflow-hidden pt-20">
        <div
          className={`absolute inset-0 ${
            theme === "dark"
              ? "bg-gradient-radial from-cyan-400/5"
              : "bg-gradient-radial from-blue-600/5"
          } to-transparent`}
        ></div>
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          ...
          <h1
            className={`text-5xl/[3.5rem] lg:text-7xl/[5.5rem] font-bold mb-8 ${
              theme === "dark"
          ...
          >
            국내 최초{" "}
            <span className={`pt-2 text-3xl lg:text-5xl block`}>
              국내 &middot; 외 통합 자동매매 플랫폼
            </span>
          </h1>
          ...
          >
            <span className="text-yellow-400">AI 트레이딩뷰</span> 기반으로{" "}
            <span className={primaryColor}>금융</span>과{" "}
            <span className={primaryColor}>IT</span>가 결합된 <br />
            혁신적인 핀테크 솔루션으로
            <br />
            <span className={accentColor}>1:1 맞춤 전략</span>과{" "}
            <span className={accentColor}>거래소 API 연동</span>을 통해 서비스를
            제공하는 <br />
            자동매매 SaaS 플랫폼입니다.
          </p>

          <div
            className={`inline-block ${cardBg} backdrop-blur-sm rounded-2xl p-6 border ${
      ...
      <section className={`py-20 ${sectionBg}`}>
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              AI 기반 자동매매부터 리스크 관리까지, 트레이딩에 필요한 모든
              기능을 제공합니다
            </p>
          </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="relative">
                  ...
                  {/* Arrow for desktop */}
                  <div className="hidden md:block absolute top-10 -right-8 text-2xl text-gray-400">
                    →
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p
              className={`text-xl ${textSecondary} max-w-3xl mx-auto leading-relaxed`}
            >
              시장의 기존 솔루션들과 차별화된 트레이딩기어만의 고유한 경쟁
              우위를 소개합니다
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* 지원 자산 및 자동집행 */}
            <div
              className={`${cardBg} backdrop-blur-sm rounded-3xl p-8 border-l-4 ${
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className={`space-y-3 ${textSecondary}`}>
                    <p>
                      • 국내외 주식+선물 통합 플랫폼으로 중류 구분없이 매매 가능
                    </p>
                    <p>
                      • 경쟁사들은 대부분 단일 자산군에 집중 (코인 전용 및 등)
                    </p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className={`space-y-3 ${textSecondary}`}>
                    ...
                    <p>
                      • 중앙 서버에 비밀번호 암호화 보관으로 내부 유출 위험 차단
                    </p>
                    <p>
                      • 업종코드 KSIC 66199 핀테크 예외 적용 정책자금 지원 대상
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className={`space-y-3 ${textSecondary}`}>
                    <p>
                      • 트레이딩뷰 차트만 제공하는 카카오페이증권과 달리 AI기반
                      전략 및 수익률 예측보고서 제공
                    </p>
                    <p>
                      • 리딩방과 달리 투명한 로그 기록으로 성과 과장·삭제 불가능
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          ...
          <div className="w-1/2 mx-auto">
            ...
            <div className={`flex${cardBg} backdrop-blur-sm rounded-2xl p-8`}>
              ...
              >
                <span className="text-yellow-400 pr-2">✓</span>저작권 등록 완료
              </h3>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className={`text-xl font-bold mb-4 ${primaryColor}`}>
                AI & 머신러닝
              </h3>
      ...
      <section className={`py-20 ${sectionBg}`}>
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <h3 className={`text-2xl font-bold mb-6 ${accentColor}`}>
                고객지원 채널
              </h3>
              <p className={`mb-6 ${textSecondary}`}>
                아래 채널을 통해 빠르게 문의하실 수 있습니다.
              </p>
      ...
      <Footer
        onLinkClick={(linkName) =>
          console.log(`About 페이지 Footer 링크 클릭: ${linkName}`)
        }
      />
    </div>
  );
